    ...
    <>
        ...
        <section className="course-details">
            <div className="container">
                ...
                (<>
                 <h4 style={{textAlign:"center"}}>Tutor Details</h4>
                <table className="table table-responsive ">
                    ...
                    <tbody>
                     { currentPageDatas.length !==0 ? currentPageDatas.map((item,index)=>(
                        ...
                        <button className='btn btn-danger' onClick={()=> handleverifyClick(item.id)}>Click to verify</button>}
                        </td>
                ...
                <h4 className='mt-5' style={{textAlign:"center"}}>Student Details</h4>
                <table className="table table-responsive">
                    <thead>
                      <tr>
                        <th>SL No</th>
